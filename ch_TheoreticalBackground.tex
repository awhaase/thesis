...
\begin{figure}[htb]
    ...
    \caption{Illustration of the perturbation potential $V^i_r(\vec{r})$ at the $i$th interface of a multilayer system. The ideal (mean) interface position is at $z=z_i$ with a height profile $h_i(\vec{r})$ indicating the deviation from that ideal interface due to roughness.}
