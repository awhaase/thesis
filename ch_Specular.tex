...
\begin{figure}[htbp]
    ...
    \caption[Model of the Cr/Sc multilayer stack including the substrate and the capping layers.]{Model of the multilayer stack including the substrate and the capping layers. The periodic part is enclosed between the dashed lines with four layers in each period repeated $N=64$ times. The capping period does not include an interdiffusion layer but has a natural SiO$_2$ layer.}
