...
This method is applied and discussed in detail in section~\ref{ch_spec:sec_reconstruction_PTB17} to a multilayer mirror composed out of Mo/B$_4$C/Si/C optimized for reflection in the spectral range between $\lambda=\nm{12.4}$ and $\lambda=\nm{14.0}$ at angles of incidence below $\alpha_i \leq \SI{15}{\degree}$ based on the specular reflectance at those wavelengths and angles.
