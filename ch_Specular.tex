...
$d_\text{SiO$_2$(cap)}$ / nm &SiO$_2$ capping layer thickness& $3.195$ \\
...
\end{figure*}
In all cases, the one-sigma standard deviations are shown together with the weighted center, i.e.~the $50$th percentile. The \gls{pso} result is also indicated. 
