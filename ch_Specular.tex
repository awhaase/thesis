...
(unpolished) && (polished) &\\
\midrule
$1.70$ &$2.43({-0.09}/{+0.16})$ & $1.70$ &$1.77({-0.22}/{+0.19})$ \\
$1.87$ &$1.81({-0.12}/{+0.24})$ & $1.85$ &$1.91({-0.12}/{+0.17})$ \\
$2.04$ &$1.98({-0.15}/{+0.14})$ & $2.00$ &$2.29({-0.28}/{+0.13})$ \\
$2.21$ &$2.08({-0.11}/{+0.22})$ & $2.15$ &$2.45({-0.43}/{+0.06})$ \\
$2.38$ &$2.31({-0.22}/{+0.21})$ & $2.30$ &$2.60({-0.12}/{+0.14})$ \\
